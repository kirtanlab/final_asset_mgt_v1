...
import { useGetAllAssetRequests } from 'src/queries/AssetRequestQueries';
...
const RequestList = () => {
    ...
    return (
      <>
        <Container maxWidth={settings.themeStretch ? false : 'xl'}>
          <Typography variant="h4"> Assets Request </Typography>
  ...
  return (
    <Container maxWidth={settings.themeStretch ? false : 'xl'}>
      <Typography variant="h4"> Assets Request Master </Typography>
      <Grid xs={12} marginTop={2}>
        <RequestDetailsTable
