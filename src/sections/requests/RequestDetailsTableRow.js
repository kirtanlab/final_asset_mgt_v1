...
const RequestDetailsTableRow = ({
  ...
  return (
    <TableRow hover selected={selected}>
      ...
      <TableCell>
        <ListItemText
          primary={row?.reportingToId?.employee_name}
          primaryTypographyProps={{ typography: 'body2', noWrap: false }}
          secondaryTypographyProps={{
            mt: 0.5,
            component: 'span',
      ...
      <TableCell>
        <Label
          ...
          color={
            ...
            (row?.status?.status === 'Allocated' && 'success') ||
      ...
      >
        ...
        {row?.status?.status === 'Pending' && role === 'employee' && (
          <>
            <MenuItem
              onClick={() => {
                setEditTypes(true);
        ...
        {row?.status?.status === 'Pending' && role === 'manager' && (
          <>
            <MenuItem
              onClick={() => {
                // confirm.onTrue();
        ...
        {row?.status?.status === 'Approved' && role === 'owner' && (
          <>
            <MenuItem
              onClick={() => {
                // confirm.onTrue();
        ...
        {row?.status?.status === 'Approved' && role === 'employee' && (
          <>
            <MenuItem
              onClick={() => {
                // confirm.onTrue();
        ...
        {row?.status?.status === 'Allocated' && role === 'owner' && (
          <>
            <MenuItem
              onClick={() => {
                // confirm.onTrue();
